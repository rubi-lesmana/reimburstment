        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input readonly
                            value="<?= set_value('id_reimburstment', $reimburstment['id_reimburstment']); ?>"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input readonly value="<?= set_value('acc_no', $reimburstment['acc_no']); ?>" name="acc_no"
                                id="acc_no" type="text" class="form-control" placeholder="Pilih ID Request ...">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <select name="bank_id" id="bank_id" class="custom-select">
                                ...
                                <option <?= $reimburstment['bank_id'] == $d['id_bank'] ? 'selected' : ''; ?>
                                    <?= set_select('bank_id', $d['id_bank']) ?> value="<?= $d['id_bank'] ?>">
                                    <?= $d['nama_bank'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input readonly value="<?= set_value('klaim_id', $reimburstment['klaim_id']); ?>"
                                name="klaim_id" id="klaim_id" type="text" class="form-control"
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input value="<?= set_value('no_rek', $reimburstment['no_rek']); ?>" name="no_rek"
                                id="no_rek" type="text" class="form-control" placeholder="No. Rekening...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input readonly value="<?= set_value('nama', $reimburstment['nama']); ?>" name="nama"
                                id="nama" type="text" class="form-control" placeholder="Nama Karyawan...">
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input readonly value="<?= set_value('amount', $reimburstment['amount']); ?>" name="amount"
                                id="amount" type="text" class="form-control" placeholder="Nama Karyawan...">
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3"
                                placeholder="Description ..."><?= set_value('description', $reimburstment['description']); ?></textarea>
                        </div>

        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('id_bank', $bank['id_bank']); ?>" name="id_bank" id="id_bank"
                            readonly="readonly" type="text" class="form-control" placeholder="ID RO...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_bank', $bank['nama_bank']); ?>" name="nama_bank"

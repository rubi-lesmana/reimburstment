        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input readonly value="<?= set_value('id_jenis_klaim', $id_jenis_klaim); ?>"
                            name="id_jenis_klaim" id="id_jenis_klaim" type="text" class="form-control"
                            placeholder="ID Jenis Klaim">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_jenis_klaim'); ?>" name="nama_jenis_klaim"
                            id="nama_jenis_klaim" type="text" class="form-control" placeholder="Nama Jenis Klaim">

        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_klaim">ID Klaim</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tgl">Tanggal</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6 text-md-right">
                        <input value="2" name="status" id="status" type="hidden" class="form-control">
                    </div>
                </div>
